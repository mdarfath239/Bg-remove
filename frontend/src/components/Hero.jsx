...
const Hero = () => {
    ...
    return (
        <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 sm:px-10 md:px-14 lg:px-28 sm:mt-20 mx-auto max-w-[90vw]'>
            {/* Left Side */}
            <div >
                ...
                <div>
                    <input onChange={onUpload} type="file" name="" id="upload1" hidden />
